          ...
          <div class="col-md-9">
            ...
            <div class="box box-warning">
              <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-plus margin-r-5"></i>Tambah Ponggawa</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>About</label>
                  <input required name="about" type="text" class="form-control" placeholder="about">
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                <a href="ponggawa.php" class="btn btn-default"><i class="fa fa-close"></i> Cancel</a>
