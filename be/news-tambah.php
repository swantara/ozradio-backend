          ...
          <div class="col-md-9">
            ...
            <div class="box box-warning">
              <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-edit margin-r-5"></i>New News</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="box-body pad">
                    <form>
                      <textarea required class="textarea" placeholder="konten" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                    </form>
                  </div>
                </div>
                <div class="form-group">
                  <label>Author</label>
                  <input required name="album" type="text" class="form-control" placeholder="author">
                </div>
                <div class="form-group">
                  <label>Link</label>
              ...
              <div class="box-footer">
                <a href="news.php" class="btn btn-default"><i class="fa fa-close"></i> Cancel</a>
