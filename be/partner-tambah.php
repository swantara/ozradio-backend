          ...
          <div class="col-md-9">
            ...
            <div class="box box-warning">
              <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-edit margin-r-5"></i>New Partner</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Link</label>
                  <input required name="album" type="text" class="form-control" value="www.durex.com">
                </div>
                <div class="form-group">
                  <label>Status</label>
              ...
              <div class="box-footer">
                <a href="partner.php" class="btn btn-default"><i class="fa fa-close"></i> Cancel</a>
